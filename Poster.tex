...
HealthOrg dispone de un conjunto de datos que contienen siete atributos de interés: género, edad, BMI (Body Max Index/índice de Masa Corporal), WHR (Waist Hip Ratio/Índice Cintura Cadera), fumador, número de veces que el paciente se ejercita por semana y si {es diabético} que es la clase que se quiere determinar.
